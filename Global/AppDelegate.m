...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"JITShowHD" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"JITShowHD.sqlite"];
...
- (void)findAllFonts {
    ...
    int size = [familyNames count];
    NSLog(@"Family size is %d", size);
    
    for (indFamily = 0; indFamily < size; ++indFamily)
    {
